...
#define PFCP_UPF_REPORT_REQUEST 200
#define PFCP_UPF_REPORT_RESPONSE 201
#define PFCP_PDU_SESSION_DATA_REPORT_REQUEST 202
#define PFCP_PDU_SESSION_DATA_REPORT_RESPONSE 203
...
#define PFCP_UPFuplinkdata_TYPE 198
#define PFCP_UPFdownlinkdata_TYPE 199
#define PFCP_PFCPuplinkdata_TYPE 200
#define PFCP_PFCPdownlinkdata_TYPE 201
#define PFCP_Timestamp_TYPE 202
#define PFCP_UPFcpu_TYPE 203
#define PFCP_UPFmem_TYPE 204
#define PFCP_UPFsto_TYPE 205
#define PFCP_Session_TEID_TYPE 206
#define PFCP_Session_UEIP_TYPE 207
#define PFCP_Session_PACKET_TYPE 208
...
typedef TlvOctet UPFuplinkdata;
typedef TlvOctet UPFdownlinkdata;
typedef TlvOctet PFCPuplinkdata;
typedef TlvOctet PFCPdownlinkdata;
typedef TlvOctet Timestamp;
typedef TlvOctet UPFcpu;
typedef TlvOctet UPFmem;
typedef TlvOctet UPFsto;
typedef TlvOctet SessionTEID;
typedef TlvOctet SessionUEIP;
typedef TlvOctet SessionPacket;
...
typedef struct _PFCPUPFReportResponse {
    unsigned long presence;
	NodeID nodeID;
    UPFcpu upfcpu;
	UPFmem upfmem;
	UPFsto upfsto;
	UPFuplinkdata upfuplinkdata;
	UPFdownlinkdata upfdownlinkdata;
	PFCPuplinkdata pfcpuplinkdata;
	PFCPdownlinkdata pfcpdownlinkdata;
	Timestamp timestamp;
} __attribute__((packed)) PFCPUPFReportResponse;

typedef struct _PFCPUPFReportRequest {
    unsigned long presence;
    NodeID nodeID;
} __attribute__((packed)) PFCPUPFReportRequest;

typedef struct _PFCPPDUSessionDataReportRequest {
	unsigned long presence;
	NodeID nodeID;
} __attribute__((packed)) PFCPPDUSessionDataReportRequest;

typedef struct _PFCPPDUSessionDataReportResponse {
	unsigned long presence;
	NodeID nodeID;
	SessionTEID teid;
	SessionUEIP ueip;
	...
	Timestamp timestamp;
} __attribute__((packed)) PFCPPDUSessionDataReportResponse;
...
typedef struct _PfcpMessage {
    ...
    union {
		...
		PFCPUPFReportRequest pFCPUPFReportRequest;
	    PFCPUPFReportResponse pFCPUPFReportResponse;
		PFCPPDUSessionDataReportRequest pFCPPDUSessionDataReportRequest;
		PFCPPDUSessionDataReportResponse pFCPPDUSessionDataReportResponse;
    };
} PfcpMessage;
