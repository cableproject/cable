...
void UpfN4HandleUPFReportRequest(PfcpXact *xact, PFCPUPFReportRequest *request);
void UpfN4HandlePDUSessionDataReportRequest(PfcpXact *xact, PFCPPDUSessionDataReportRequest *request, uint16_t i);
